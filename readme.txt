		...
		<div class="row narrow">
			<div class="col col-span-1 middle-left" style="width:100%;">
				...
				<span style="margin-bottom:-50px; margin-top: 70px;">
					...
					<svg height="40" width="40" style="z-index: 2; cursor: pointer;" onclick="return changeBannerImage('1')">
					  <circle cx="20" cy="20" r="10" stroke="grey" stroke-width="1" fill="rgba(240,240,240, 0.3)" />
					</svg>
					<svg height="40" width="40" style="z-index: 2; cursor: pointer;" onclick="return changeBannerImage('2')">
					  <circle cx="20" cy="20" r="10" stroke="grey" stroke-width="1" fill="rgba(240,240,240, 0.3)" />
					</svg>
					<svg height="40" width="40" style="z-index: 2; cursor: pointer;" onclick="return changeBannerImage('3')">
					  <circle cx="20" cy="20" r="10" stroke="grey" stroke-width="1" fill="rgba(240,240,240, 0.3)" />
					</svg>
				</span> 
			</div>
