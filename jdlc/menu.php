...
<div class="menu-items">
  <span><a href="<?php echo get_permalink(get_page_by_path('facilities')); ?>">FACILITIES</a></span>
  ...
  <a class="contact-anchor" href="<?php echo get_permalink(get_page_by_path('contact')); ?>"><span class="contact-button">CONTACT</span></a>
</div>
</div>
